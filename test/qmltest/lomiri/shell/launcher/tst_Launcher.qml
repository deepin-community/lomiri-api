...
Item {
    ...
    Verifier {
        ...
        function test_model_data() {
            return [
                ...
                { tag: "LauncherModel[LauncherModelInterface]", type: "lomiri::shell::launcher::LauncherModelInterface" },
            ];
        }
    ...
    Verifier {
        ...
        function test_model_properties_data() {
            return [
                { tag: "Model.properties[applicationManager]", property: "applicationManager", type: "lomiri::shell::application::ApplicationManagerInterface" },
        ...
        function test_quicklist_model_roles_data() {
            return [
                ...
                { tag: "Model.roles[isPrivate]", role: "isPrivate", type: "boolean" }
            ];
        }
